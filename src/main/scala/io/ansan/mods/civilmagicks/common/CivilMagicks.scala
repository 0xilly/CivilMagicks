...
package io.ansan.mods.civilmagicks.common

import io.ansan.mods.civilmagicks.api.ICivilMagicksAPI
import io.ansan.mods.civilmagicks.api.mana.ManaType
import io.ansan.mods.civilmagicks.client.ClientRegistryListener
import io.ansan.mods.civilmagicks.common.apiimpl.API
import io.ansan.mods.civilmagicks.common.eventhandler.RegistryHandler
import io.ansan.mods.civilmagicks.common.item.ModItems
import io.ansan.mods.civilmagicks.common.util.helpers.{BrewHelper, EffectsHelper}
...
object CivilMagicks {
  ...
  final val ITEM_GROUP: ItemGroup = new ItemGroup("civilmagicks") {
    override def makeIcon(): ItemStack = new ItemStack(ModItems.MANA_SPRING)
  }
  final val BREW_GROUP: ItemGroup = new ItemGroup("Brews") {
    override def makeIcon(): ItemStack = new ItemStack(ModItems.BREW)
  }
}
